...
QEMU_MACHINE :=
QEMU_EXTRA_FLAGS :=
QEMU_MACHINE_DEF := -DSTM32F030x8 -DRK_MCU_F030R8 -D__NVIC_PRIO_BITS=2 -DRK_CONF_SYSCORECLK=$(F030R8_SYSCORECLK) -DRK_CONF_N_USRTASKS_MAX=3U $(F030R8_SYSTICK_DIV_DEF)
