...
RK_ERR kQueuePost( RK_QUEUE *const kobj, const ADDR sendPtr, RK_TICK const timeout);
 ...
 * \return RK_SUCCESS or specific error
 */
RK_ERR kEventFlagsSet( RK_EVENT *const kobj, const ULONG flagMask,
 ...
 * \param options RK_FLAGS_ANY_(KEEP/CLEAR), RK_FLAGS_ALL_(KEEP/CLEAR)
 ...
 * \return RK_SUCCESS or specific error
 */
RK_ERR kEventFlagsGet( RK_EVENT *const kobj, const ULONG requiredFlags,
