...
The '0' implies a deliberate return to the roots of real-time and concurrent program design — before excessive generalisation of mechanisms, loose semantics and the coordination that emerges from that.

The core principle:

> Execution progress must be explicit.

The result is orthogonal mechanisms that encode the *cause of progress* directlye.
