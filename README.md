...
* [RK0 Wiki](https://github.com/antoniogiacomelli/RK0/wiki): useful information such as setting up environment (VSCode/QEMU) (Linux/Win/MacOS) and also functional packages for Nucleo-boards (M0/M3/M4).
