...
**_RK0 is a small real-time kernel built from established concepts. The originality lies in its relationship-oriented service model, its generalised treatment of priority dependencies, its coordination-authority restrictions. Prioritising specialised semantics over unrestricted primitive composition is a key for expressing expected execution progress and feed the kernel with information to handle edge cases, on an easy to maintain and reason codebase._**
