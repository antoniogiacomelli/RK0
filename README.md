...
*  [RK0 Wiki](https://github.com/antoniogiacomelli/RK0/wiki)  Users's Guide, QEMU setup, Reference projects for download (Nucleo boards)

*  [RK0 Blog](https://kernel0.org/blog/) provides some quick complementary reads.

---

## RK0 Main Features (V0.9.12-dev)
