 ...
 * USART2 was already configured by default.
 * C Newlib was in the package and to create kprintf() was as simply as creating
 * the _write backend syscall using the (well-documented) registers within the
 * HAL.
 */
